...
<body>
	<div class="text2">
		<form action="<%=path%>/stuClassModifyServlet" method="post">
			<table width="1200" border="0" align="center" class="word_darkGrey">
				<tr>
					<td>小组编号：</td>
					<td><label> <input type="text" name="clanum"
							style="border: 0px;" id="clanum" readonly="readonly"
							value="${stuClassMap.id }" />
					</label></td>
				...
				<tr>
					<td width="103">小组名称：</td>
					<td width="240"><label> <input type="text"
							name="claname" id="claname" value="${stuClassMap.name }" />
					</label></td>
					<td>请不要起重复的名称</td>

...
<body>
	<h3 class="subTitle">
		小组培训管理
		<div class="search">
			<form action="<%=path%>/scheduleQueryServlet" method="get">
				科目名称 : <input type="text" name="courseSearch"
					value="${courseSearch }"> <input type="submit"
					class="btn_grey" value="搜索">
			</form>
		</div>
		&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=path%>/scheduleAddServlet">新加培训信息</a>
	</h3>
	<br />
	<table width="90%" border="0" align="center" cellpadding="0"
		...
		<tr align="center">
			...
			<td width="162">科目名称</td>
			<!-- <td width="90">所属分类</td> -->
			<td width="171">培训教练</td>
			<td width="120">分管小组</td>
			<td width="94">修改操作</td>
		...
		<c:forEach var="tc" items="${tcList}">
			<tr align="center">
				...
				<td><a href="<%=path%>/scheduleDeleteServlet?info=${tc.tcId}"
